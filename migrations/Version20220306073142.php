 ...
 */
final class Version20220306073142 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sms_text (id INT AUTO_INCREMENT NOT NULL, phone VARCHAR(255) NOT NULL, code VARCHAR(255) DEFAULT NULL, text LONGTEXT NOT NULL, send_at DATETIME NOT NULL, valid TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE attempts ADD CONSTRAINT FK_BFC7E764B5FC0459 FOREIGN KEY (codeId) REFERENCES sms_text (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE sms_text');
